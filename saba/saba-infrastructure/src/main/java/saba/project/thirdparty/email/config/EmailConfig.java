package saba.project.thirdparty.email.config;
...
import saba.project.thirdparty.email.EmailProperties;
...
public class EmailConfig {
    ...
    public JavaMailSender mailSender() {//JAVA MAILSENDER 인터페이스를 구현한 객체를 빈으로 등록하기 위함.
        ...
        mailSender.setUsername(emailProperties.getUsername());//구글계정을 넣습니다.
        mailSender.setPassword(emailProperties.getPassword());//구글 앱 비밀번호를 넣습니다.
